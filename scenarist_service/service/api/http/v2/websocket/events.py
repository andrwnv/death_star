...
from death_star.scenarist.abstract_event import AbstractEvent
from death_star.scenarist.event_executor import IEventExecutorManager
...
class EventWebSocketRouter(APIRouter):
    ...
    async def __loop(self, websocket: WebSocket):
        ...
        await self.__websocket.send_json(
            {"connection": True, "session_cookie": str(_uuid)}
        )
