...
class DevToolsApiRouter(APIRouter):
    def __init__(self, scenario_start_method, events_start_method, model: Model, *args, **kwargs) -> None:
        ...
        self.add_api_route(path='/{secret_key}',
                           methods=['GET'], endpoint=self.manipulate, tags=['DEV'], name='Хммммм, a что же это кхм-кхм-кхм')
